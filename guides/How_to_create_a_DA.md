...
15. **Validate the JSON**
    - Use the [manifest_validation_checklist](https://github.com/IBM/da-bootstrap/blob/main/guides/Manifest_validation_checklist.md) to validate the manifest json.
